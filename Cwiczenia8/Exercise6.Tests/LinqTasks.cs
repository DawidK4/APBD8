...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = from emp in Emps
                ...
                select new
                {
                    name = departmentGroup.Key,
                    numOfEmployees = departmentGroup.Count()
                };
        ...
        {
            IEnumerable<Emp> result = Emps.HasDirectReports();
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> HasDirectReports(this IEnumerable<Emp> emps)
        {
            return emps.Where(e => emps.Any(subordinate => subordinate.Mgr == e))
                .OrderBy(e => e.Ename)
